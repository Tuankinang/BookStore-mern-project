...
import { FiShoppingCart, FiMinus, FiPlus, FiCheckCircle, FiRefreshCw, FiPhone, FiTruck } from "react-icons/fi";
    ...
    <div className="bg-gray-50 pb-12">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-3 text-sm text-gray-500">
          ...
          <span className="capitalize hover:text-blue-600 cursor-pointer">{book?.category}</span>
          <span className="mx-2">/</span>
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden p-6 md:p-8">
          <div className="flex flex-col md:flex-row gap-10">
            ...
            <div className="w-full md:w-7/12 lg:w-8/12 flex flex-col">
              ...
              <div className="flex items-center gap-4 text-sm text-gray-600 mb-6 border-b pb-4">
                ...
                <p>Tình trạng: 
                    <span className={`ml-1 font-bold ${book?.stock > 0 ? 'text-green-600' : 'text-red-600'}`}>
                        {book?.stock > 0 ? "Còn hàng" : "Hết hàng"}
                    </span>
                </p>
                <span className="h-4 w-px bg-gray-300"></span>
                <p>Mã SP: <span className="text-gray-900 font-medium">#{id.slice(-6).toUpperCase()}</span></p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 mb-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-center">
                    ...
                    <div className="flex flex-col w-full sm:w-auto">
                        <span className="text-sm font-semibold mb-1 text-gray-700">Số lượng:</span>
              ...
              <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-start gap-3 p-3 border rounded bg-white hover:shadow-sm transition">
                      ...
                      <div>
                          <p className="font-bold text-sm text-gray-800">Miễn phí vận chuyển</p>
                  ...
                  <div className="flex items-start gap-3 p-3 border rounded bg-white hover:shadow-sm transition">
                      ...
                      <div>
                          <p className="font-bold text-sm text-gray-800">Chính hãng 100%</p>
                  ...
                  <div className="flex items-start gap-3 p-3 border rounded bg-white hover:shadow-sm transition">
                      ...
                      <div>
                          <p className="font-bold text-sm text-gray-800">Đổi trả 30 ngày</p>
                  ...
                  <div className="flex items-start gap-3 p-3 border rounded bg-white hover:shadow-sm transition">
                      ...
                      <div>
                          ...
                          <p className="text-xs text-gray-500">Hotline: 0905.474.805</p>
                      </div>
                  </div>
              </div>
          ...
          <div className="mt-12 border-t pt-8">
            ...
            <div className="prose max-w-none text-gray-700 leading-relaxed bg-gray-50 p-6 rounded-lg border border-gray-100">
                <p className="mb-4">
                    <strong>{book.title}</strong> là một cuốn sách thuộc thể loại <span className="capitalize font-semibold text-blue-600">{book.category}</span>. 
                    Dưới đây là nội dung chi tiết:
                </p>
                <p className="mb-4">{book.description}</p>
                <p className="italic text-gray-500 text-sm">
                    *Lưu ý: Hình ảnh bìa sách có thể thay đổi tùy thuộc vào đợt tái bản của nhà xuất bản.
                </p>
            </div>
          </div>
