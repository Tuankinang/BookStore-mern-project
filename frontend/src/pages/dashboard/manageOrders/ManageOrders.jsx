          ...
          <div className="bg-white rounded-lg shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center p-6 border-b bg-gray-50">
              <h3 className="text-lg font-bold text-gray-800">
                Chi tiết đơn hàng{" "}
                <span className="text-indigo-600">#{selectedOrder._id}</span>
              </h3>
              <button
                onClick={closeModal}
                    ...
                    {selectedOrder.productIds.map((item, index) => (
                      <tr key={index}>
                        ...
                        <td className="px-4 py-3 text-sm text-gray-500 text-right">
                          {formatPrice(item.productId?.newPrice)}
                        </td>
                        ...
                        <td className="px-4 py-3 text-sm text-gray-900 text-right font-bold">
                          {formatPrice(
                            (item.productId?.newPrice || 0) * item.quantity
                          )}
                        </td>
                      </tr>
                    ))}
            ...
            <div className="p-4 bg-gray-50 border-t flex justify-end">
              <button
                onClick={closeModal}
                className="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-100 font-medium transition"
              >
                Đóng
              </button>
            </div>
